...
function runData() {
  ...
  svg.append('text').attr('class', 'axis-desc').attr('x', '20').attr('y', '480').text('0');
  svg.append('circle').attr('cx', '60').attr('cy', '60').attr('r', '5').attr('fill', 'purple');
  ...
  .data(speedData).enter().append('circle').attr('class', 'data').attr('cx', function (d) {
    return (2400 - d) * 4.5;
    ...
    return $('.hover' + i).css('display', 'inline-block');
